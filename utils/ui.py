...
def inject_css():
    ...
    <style>
        ...
        .card-black { color: #FAFAFA; }
        
        .decision-call { background: rgba(0, 255, 170, 0.1); border-radius: 8px; padding: 1rem; border-left: 4px solid #00FFAA; margin-top: 1rem; }
        .decision-fold { background: rgba(255, 85, 85, 0.1); border-radius: 8px; padding: 1rem; border-left: 4px solid #FF5555; margin-top: 1rem; }
        .decision-raise { background: rgba(0, 204, 255, 0.1); border-radius: 8px; padding: 1rem; border-left: 4px solid #00CCFF; margin-top: 1rem; }
    </style>
    """
